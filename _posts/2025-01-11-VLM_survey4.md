...
- **CoCoOp** (https://arxiv.org/pdf/2203.05557) (CVPR 2022)
  ...
  - Proposal: **Conditional Context Optimization (CoOp)**
...
- **LASP** (https://arxiv.org/pdf/2210.01115) (CVPR 2023)
  ...
  - Recent trend: **Soft** prompt learning 
    ...
    $$\rightarrow$$ Recent methods: Overfit the training data
  ...
  - Text-to-text cross-entropy loss ( (a) vs. (b) )
    - (a) Learned prompts
    - (b) Pre-defined hand-crafted textual prompts. 
...
- **KgCoOp** (https://arxiv.org/pdf/2303.13283) (CVPR 2023)
  ...
  - Adding the KgCoOp loss upon the contrastive loss!
...
- **SoftCPT** (https://arxiv.org/abs/2208.13474) (arxiv 2022)
  ...
  - Motivation: Many few-shot tasks are inherently correlated!
    ...
    - Particularly within specialized domains

      $$\rightarrow$$  However, such information is overlooked previously!!

  - How? 
    - Fine-tune pre-trained VLMs on ***multiple target few-shot tasks*** jointly
    - Design a **task-shared meta network**
      - To generate prompt context for each task with..
        - (1) task name + (2) learnable task context
...
- **PLOT** (https://arxiv.org/pdf/2210.01253) (ICLR 2023)
  ...
  - Conventional methods: Learn ***one*** prompt

  - Proposal: Learn ***multiple*** prompts

    - To describe diverse characteristics of categories
  ...
  - Procedure
    - Step 1) Visual and textual feature sets
