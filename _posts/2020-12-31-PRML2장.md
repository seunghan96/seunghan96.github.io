...
- determinant of $$J$$ matrix :
  ...
  $$\mid\mathbf{J}\mid^{2}=\left\mid\mathbf{U}^{\mathrm{T}}\right\mid^{2}=\left\mid\mathbf{U}^{\mathrm{T}}\right\mid\mid\mathbf{U}\mid=\left\mid\mathbf{U}^{\mathrm{T}} \mathbf{U}\right\mid=\mid\mathbf{I}\mid=1$$
