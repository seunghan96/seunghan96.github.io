...
- Analyze VLM's generalization ability over unseen tasks without task-specific fine-tuning
- Three Tasks
...
- (3) Task-agnostic learning
  - Supervision in VLM pre-training is usually general and task-agnostic
...
**VLM pre-training methods** for object detection and semantic segmentation 

- with local VLM pre-training objectives (e.g., region-word matching)

![figure2](/assets/img/llm/img494.png)

VLMs enable effective zero-shot prediction on both dense prediction tasks!

<br>

### P5) Limitation of VLMs

- (1) The performance saturates and further scaling up won’t improve performance
