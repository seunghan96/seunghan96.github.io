...
$B\left(x_{c}, r\right)=\left\{x \mid\left\|x-x_{c}\right\|_{2} \leq r\right\}=\left\{x \mid\left(x-x_{c}\right)^{T}\left(x-x_{c}\right) \leq r^{2}\right\}$ with $r \geq 0$

( 혹은 $B\left(x_{c}, r\right)=\left\{x_{c}+r u \mid\|u\|_{2} \leq 1\right\}$ )

- $\|.\|_{2}$ : euclidean norm … $\|u\|_{2}=\left(u^{T} u\right)^{\frac{1}{2}}$
...
$\left\{x \mid\left\|x-x_{c}\right\| \leq r\right\}$.
...
$C=\{(x, t):\|x\| \leq t\} \subseteq R^{n+1} \text {, for a norm }\|\cdot\|$.
