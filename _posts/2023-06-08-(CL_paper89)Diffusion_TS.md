...
4.1. Setup
Experiments are performed on nine real-world time series datasets (Table 1) (Zhou et al., 2021; Wu et al., 2021; Fan et al., 2022): (i) $\mathrm{NorPool}^1$, which includes eight years of hourly energy production volume series in multiple European countries; (ii) Caiso ${ }^2$, which contains eight years of hourly actual electricity load series in different zones of California; (iii) Traffic ${ }^3$, which records the hourly road occupancy rates generated by sensors in the San Francisco Bay area freeways; (iv) Electricity ${ }^4$, which includes the hourly electricity consumption of 321 clients over two years; (v)
