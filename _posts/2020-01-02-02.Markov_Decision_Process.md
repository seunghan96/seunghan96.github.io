...
이는, 다르게 말하면 미래의 상태($$S_{t+1}$$)는 **지금 현재 상태($$S_t$$) 만으로도 충분**하다는 것을 의미한다 ( sufficient statistic of the future )
...
<img src="https://t1.daumcdn.net/cfile/tistory/99E9FD355AEB1E0927" width="450" />.
