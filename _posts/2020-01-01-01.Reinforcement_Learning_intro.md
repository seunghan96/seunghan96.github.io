...
위 식은 value function $$V_{\pi}(s)$$ 를 나타내는 식으로, 해석하자면 "현재 상태 $$s_0$$에서 정책 <a href="https://www.codecogs.com/eqnedit.php?latex=\pi" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\pi" title="\pi" /></a>
...
상태에서 취할 행동"이 주어졌을 때의 Reward 관련된 함수이다. 이를 식으로 나타내면 다음과 같다. <br>

$$Q_\pi (s,a) = E[R(s0,a0)+\gamma R(s1,a1) +\gamma^2 R(s2,a2)+....\mid s0=s,a0=a,\pi ]$$
