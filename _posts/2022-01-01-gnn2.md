...
- example
  - 1) common neighbors : $$\left|N\left(v_{1}\right) \cap N\left(v_{2}\right)\right|$$
  - 2) Jaccard's coefficient : $$\frac{\left|N\left(v_{1}\right) \cap N\left(v_{2}\right)\right|}{\left|N\left(v_{1}\right) \cup N\left(v_{2}\right)\right|}$$
