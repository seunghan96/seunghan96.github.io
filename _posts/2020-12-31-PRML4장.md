...
$$p\left(\mathcal{C}_{1} \mid \phi\right)=y(\phi)=\sigma\left(\mathbf{w}^{\mathrm{T}} \boldsymbol{\phi}\right)$$
...
- $$\ln f(z)  \simeq \ln f\left(z_{0}\right)-\frac{1}{2} A\left(z-z_{0}\right)^{2}$$
  ...
  where $$A =-\left.\frac{d^{2}}{d z^{2}} \ln f(z)\right|_{z=z_{0}}$$
...
- $$\ln f(\mathbf{z}) \simeq \ln f\left(\mathbf{z}_{0}\right)-\frac{1}{2}\left(\mathbf{z}-\mathbf{z}_{0}\right)^{\mathrm{T}} \mathbf{A}\left(\mathbf{z}-\mathbf{z}_{0}\right)$$
  ...
  where $$\mathbf{A}=-\left.\nabla \nabla \ln f(\mathbf{z})\right|_{\mathbf{z}=\mathbf{z}_{0}}$$ ( $$H$$ x $$H$$ matrix )
